				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectField, {
						...
						options: [
							{
								value: "tavily-only",
								label: t("searchModeTavilyOnly")
							},
							{
								value: "deepseek-first",
								label: t("searchModeDeepseekFirst")
							},
							{
								value: "tavily-first",
								label: t("searchModeTavilyFirst")
							}
						],
						onEdit: (text) => {
							props.edit("searchMode", text);
						},
						onReset: () => {
							props.resetField("searchMode");
						}
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
