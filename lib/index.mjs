...
function apply(ctx, config) {
	...
	ctx.web.registerSearchProvider(new TavilySearchProvider(() => resolveOptions(ctx, current(), entry), () => hybridFor(ctx, current)));
}
...
//#endregion
export { Config, TAVILY_DEFAULT_API_KEY_ENV, TAVILY_DEFAULT_BASE_URL, TAVILY_DEFAULT_INCLUDE_ANSWER, TAVILY_DEFAULT_INCLUDE_RAW_CONTENT, TAVILY_DEFAULT_MAX_RESULTS, TAVILY_DEFAULT_SEARCH_DEPTH, TAVILY_DEFAULT_TIMEOUT, TAVILY_DEFAULT_TOPIC, TAVILY_DEFAULT_USAGE_PATH, TAVILY_PROVIDER_ID, TavilySearchProvider, WEB_SEARCH_TAVILY_SETTINGS_NAMESPACE, apply, estimateSearchCredits, inject, name };
