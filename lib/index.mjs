...
function classifiedSearchError(error, signal, timeoutSignal, timeoutMs) {
	if (timeoutSignal?.aborted === true) return tavilyWebError("timeout", `Tavily search timed out after ${timeoutMs}ms`, { cause: error });
