...
const Config = z.object({
	...
	searchDepth: z.union(["basic", "advanced"]).description("basic is faster/cheaper; advanced performs deeper retrieval."),
	topic: z.union([
		"general",
		"news",
		"finance"
