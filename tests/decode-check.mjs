...
const cases = [
  ...
  ['cache cap/bypass/debug valid', { cacheMaxEntries: 500, cacheBypassFresh: false, debug: true }],
  ['cache cap too small', { cacheMaxEntries: 0 }],
  ['cache cap too large', { cacheMaxEntries: 10001 }],
